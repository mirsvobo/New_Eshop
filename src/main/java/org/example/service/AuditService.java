...
public class AuditService {
    ...
    public void log(String module, String action, String details) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                log.error("Nepodařilo se uložit audit log pro modul {}: ", module, e);
            }
        });
    }
    ...
    private String getClientIp() {
        try {
            ...
            log.warn("Nepodařilo se získat IP adresu pro audit log", e);
        }
        return "Neznámá IP";
    }

    public List<AuditLog> getFilteredLogs(Long userId, String module) {
    ...
    public List<String> getAllModules() {
        return List.of("DOCHÁZKA", "SKLAD", "OBJEDNÁVKY", "PRODUKTY", "UŽIVATELÉ", "SYSTÉM");
    }
}